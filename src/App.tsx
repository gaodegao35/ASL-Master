            ...
            >
              ...
              <div>
                ...
                <p className="text-base font-bold text-gray-700 leading-relaxed">
                  You are about to enter Level 2, where no gesture hints or instructions are provided. 
                  Make sure you’re familiar with the gestures in Level 1 before continuing.
                </p>
              </div>
              <div className="flex flex-col gap-3">
                <button 
